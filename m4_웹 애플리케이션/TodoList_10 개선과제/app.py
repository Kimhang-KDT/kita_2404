...
def index():
    ...
    tasks = Task.query.filter_by(user_id=user_id).order_by(asc(Task.due_date)).all()
    ...
    return render_template("index.html", username=username, tasks=tasks_with_info, user_id=user_id)
...
def task_list():
    ...
    return render_template(
        "task_list.html", tasks=tasks_with_info, current_date=current_date, user_id=session['user_id']
    )
...
def add_task():
    ...
    return render_template("add_task.html", form=form, csrf_token=csrf_token, user_id=session['user_id'])
...
def profile():
    ...
    return render_template("profile.html", form=form, user_id=session['user_id'])
